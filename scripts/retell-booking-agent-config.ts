...
function buildStaffMessageTool(
	...
	return {
		...
		description: `Email ${staffRecipient} and save a call outcome when a caller leaves a message, needs human follow-up, or showed booking interest but did not book. Include the reason and service/location/time details when relevant.`,
		headers: toolHeaders,
		method: 'POST',
		parameters: {
			type: 'object',
