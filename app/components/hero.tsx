				...
				<div className="flex h-full w-full animate-slide-top flex-col items-center justify-center space-y-4 [animation-fill-mode:backwards]">
					<div className="flex flex-col items-center justify-center">
						...
						<div className="my-1 flex flex-col items-center justify-center gap-2 lg:my-2">
							...
							<div className="text-lg tracking-[.3rem] text-muted-foreground sm:tracking-[.8rem] md:text-xl lg:my-2 lg:text-2xl">
								{bottomText}
							</div>
							<h1 className="text-md text-muted-foreground sm:text-lg md:text-xl lg:text-2xl">
								{subText}
							</h1>
						</div>
					</div>
