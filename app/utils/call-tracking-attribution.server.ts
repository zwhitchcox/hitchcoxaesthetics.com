...
export const callTrackingSessionAttributionInputSchema = z
	.object({
		...
		ga_client_id: optionalTrimmedString,
		ga_session_id: optionalTrimmedString,
...
export async function recordCallTrackingSessionAttribution(
	...
	const data = {
		...
		gaClientId: normalizeOptionalString(parsed.ga_client_id),
		gaSessionId: normalizeOptionalString(parsed.ga_session_id),
