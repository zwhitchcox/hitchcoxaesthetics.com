export default function PrivacyRoute() {
	return (
		<div>
			<h1>HIPPA – Data Use Agreement</h1>
			<div>
				<p>
				...
				<p>
					...
					revised Notice of Privacy Practices. You may request a revised version
					by accessing our website, or calling the office and requesting that a
					revised copy be sent to you in the mail or asking for one at the time
					of your next appointment.
				</p>

				<p>1. Uses and Disclosures of Protected Health Information</p>
				...
				<p>
					...
					protected health information that your physician’s office is permitted
				...
				<p>
					...
					care with another provider. We will also disclose protected health
					information to other physicians who may be treating you. For example,
					...
					necessary information to diagnose or treat you. In addition, we may
				...
				<p>
					Payment: Your protected health information will be used and disclosed,
					as needed, to obtain payment for your health care services provided by
				...
				<p>
					...
					of interest to you. You may contact our Privacy Officer to request
				...
				<p>
					...
					following situations without your authorization or providing you the
				...
				<p>
					...
					that is permitted by law to collect or receive the information. For
					example, a disclosure may be made for the purpose of preventing or
				...
				<p>
					...
					Administration for the purpose of quality, safety, or effectiveness of
					FDA-regulated products or activities including, to report adverse
					events, product defects or problems, biologic product deviations, to
				...
				<p>
					...
					disclosure is expressly authorized), or in certain conditions in
				...
				<p>
					...
					conduct, (5) in the event that a crime occurs on the premises of our
					practice, and (6) medical emergency (not on our practice’s premises)
				...
				<p>
					...
					information for the reasons covered by your written authorization.
					Please understand that we are unable to take back any disclosures
				...
				<p>
					Facility Directories: Unless you object, we will use and disclose in
					our facility directory your name, the location at which you are
					receiving care, your general condition (such as fair or stable), and
					...
					Your religious affiliation will be only given to a member of the
					clergy, such as a priest or rabbi.
				</p>

				<p>
					Others Involved in Your Health Care or Payment for your Care: Unless
				...
				<p>
					...
					health information. You may obtain your medical record that contains
					medical and billing records and any other records that your physician
					and the practice uses for making decisions about you. As permitted by
					federal or state law, we may charge you a reasonable copy fee for a
				...
				<p>
					...
					proceeding; and laboratory results that are subject to law that
					prohibits access to protected health information. Depending on the
					circumstances, a
				</p>
				<p>
					decision to deny access may be reviewable. In some circumstances, you
				...
				<p>
					...
					request. If your physician does agree to the requested restriction, we
					may not use or disclose your protected health information in violation
				...
				<p>
					...
					so long as we maintain this information. In certain cases, we may deny
				...
				<p>
					...
					our Privacy Officer if you have questions about amending your medical
					record.
				</p>
				...
				<p>
					Practices. It excludes disclosures we may have made to you if you
					authorized us to make the disclosure, for a facility directory, to
					family members or friends involved in your care, or for notification
					purposes, for national security or intelligence, to law enforcement
					(as provided in the privacy rule) or correctional facilities, as part
					of a limited data set disclosure. You have the right to receive
					specific information regarding these disclosures that occur after
