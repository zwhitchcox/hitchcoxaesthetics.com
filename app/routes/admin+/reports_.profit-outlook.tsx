	...
	return (
		...
		>
			...
			<section>
				...
				<p className="note">
					Scope: the tax bill here is ONLY the tax generated by business profit
					(30% ≈ self-employment + income tax after QBI at the household's
					marginal rate). Total household tax also includes what's withheld from
					Zane's paychecks automatically, that part never needs saving for,
					which is why it isn't shown.
				</p>
			</section>
		</ReportPage>
	)
