		...
		>
			...
			<section>
				...
				<p className="note">
					...
					receipts (expenses never reduce it) plus franchise tax (~$200/yr;
					excise is $0 for an individual-owned SMLLC because SE-taxed income
					is deducted), both due Apr 15 (docs/taxes/README.md has the steps).
