...
<head>
    ...
    <title>Lip Flip \$129 — Knoxville | Sarah Hitchcox Aesthetics</title>
    <meta name="description" content="Lip Flip for just \$129. Perfect 5.0 Google rating with 217+ reviews. RN-administered in Knoxville, TN. Book your appointment today.">
...
<body>
    ...
    <header class="b-header">
        <div class="b-header-inner">
            ...
            <a href="https://www.joinblvd.com/b/sarahhitchcox/widget#/locations" class="b-header-cta" target="_blank" rel="noopener">
                Schedule Now
            </a>
        </div>
    </header>
            ...
            <div class="container">
                <div class="b-hero-grid">
                    <div class="b-hero-content">
                        ...
                        <h1>The Perfect<br><span>Lip Flip</span> — \$129</h1>
                        <p class="b-hero-price">A subtle, natural upper lip enhancement — no filler needed. <strong>Just \$129</strong>. RN-administered with a perfect 5-star rating.</p>
                        ...
                        <div class="b-hero-ctas">
                            <a href="https://www.joinblvd.com/b/sarahhitchcox/widget#/locations" class="b-btn b-btn-dark" target="_blank" rel="noopener">
                    ...
                    <div class="b-hero-photo">
                        ...
                        <div class="b-hero-photo-badge">Just \$129 — No Filler Needed</div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="b-results">
            <div class="container">
                ...
                <div class="b-ba-grid">
                    <div>
                        <div class="b-ba-pair">
                            <div class="b-ba-img"><img src="https://images.pexels.com/photos/11956948/pexels-photo-11956948.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Natural lips before lip flip" loading="lazy"><span class="b-ba-tag">Before</span></div>
                            <div class="b-ba-img"><img src="https://images.pexels.com/photos/16044145/pexels-photo-16044145.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Fuller lips after lip flip" loading="lazy"><span class="b-ba-tag">After</span></div>
                        </div>
                        <p class="b-ba-label">Upper Lip Enhancement</p>
                    </div>
                    <div>
                        <div class="b-ba-pair">
                            <div class="b-ba-img"><img src="https://images.pexels.com/photos/7479545/pexels-photo-7479545.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Natural lip shape" loading="lazy"><span class="b-ba-tag">Before</span></div>
                            <div class="b-ba-img"><img src="/img/before-after/botox-lip-flip-001-after.webp" alt="Enhanced lip definition" loading="lazy"><span class="b-ba-tag">After</span></div>
                        </div>
                        <p class="b-ba-label">Lip Definition</p>
                    </div>
                    <div>
                        <div class="b-ba-pair">
                            <div class="b-ba-img"><img src="/img/before-after/botox-lip-flip-001-before.webp" alt="Lip flip treatment" loading="lazy"><span class="b-ba-tag">Treatment</span></div>
                            <div class="b-ba-img"><img src="/img/before-after/botox-lip-flip-003-after.webp" alt="Beautiful results" loading="lazy"><span class="b-ba-tag">Results</span></div>
                        </div>
                        <p class="b-ba-label">Natural Results</p>
                    </div>
                </div>

                <div class="b-results-cta">
                    <a href="https://www.joinblvd.com/b/sarahhitchcox/widget#/locations" class="b-link" target="_blank" rel="noopener">Book Your Consultation &rarr;</a>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="b-provider-card">
                    ...
                    <div>
                        ...
                        <a href="https://www.joinblvd.com/b/sarahhitchcox/widget#/locations" class="b-btn b-btn-dark" target="_blank" rel="noopener" style="display:inline-flex;">
                            Book with Sarah
                        </a>
                    </div>
                </div>
        ...
        <section class="c-faq">
            <div class="c-faq-inner">
                ...
                <div class="c-faq-item">
                    ...
                    <div class="c-faq-a">
                        <div class="c-faq-a-inner">A Lip Flip uses a small amount of neuromodulator (like Botox) injected into the upper lip muscle to gently relax it, causing the lip to "flip" slightly outward. It creates a fuller, more defined upper lip without filler.</div>
                    </div>
                </div>
                ...
                <div class="c-faq-item">
                    ...
                    <div class="c-faq-a">
                        <div class="c-faq-a-inner">A Lip Flip subtly enhances your upper lip shape using a neuromodulator (\$129), while Lip Filler adds volume and fullness using hyaluronic acid (starting at \$450). Many clients start with a Lip Flip to see if they like the look before committing to filler.</div>
                    </div>
                </div>
                ...
                <div class="c-faq-item">
                    ...
                    <div class="c-faq-a">
                        <div class="c-faq-a-inner">A Lip Flip involves just a few tiny injections above the upper lip. Most clients describe it as a quick pinch. The entire procedure takes about 5-10 minutes with minimal discomfort and no downtime.</div>
                    </div>
                </div>
                ...
                <div class="c-faq-item">
                    ...
                    <div class="c-faq-a">
                        <div class="c-faq-a-inner">Lip Flip results typically last 2-3 months. Results appear within 3-5 days as the muscle relaxes and the upper lip gently flips outward. Regular maintenance keeps the look consistent.</div>
                    </div>
                </div>
                ...
                <div class="c-faq-item">
                    ...
                    <div class="c-faq-a">
                        <div class="c-faq-a-inner">If your upper lip tends to disappear when you smile, or you want a subtle enhancement without the commitment of filler, a Lip Flip is a great option. Sarah will assess your goals during a free consultation.</div>
                    </div>
                </div>

                <div class="c-faq-item">
                    <button class="c-faq-q" aria-expanded="false" onclick="toggleFaq(this)">
                        Can I combine a Lip Flip with other treatments?
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path d="M19 9l-7 7-7-7"/></svg>
                    </button>
                    <div class="c-faq-a">
                        <div class="c-faq-a-inner">Yes! Many clients combine a Lip Flip with Botox for forehead lines or crow's feet in the same appointment. Sarah can customize a treatment plan during your free consultation.</div>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="b-loc-grid">
                    <div class="b-loc-card">
                        ...
                        <div class="b-loc-actions">
                            ...
                            <a href="https://www.joinblvd.com/b/sarahhitchcox/widget#/locations" class="b-loc-link" target="_blank" rel="noopener">
    ...
    <section class="b-final">
        <div class="container">
            ...
            <p>A subtle, natural lip enhancement for just \$129. Book your appointment today.</p>
            <div class="b-final-ctas">
                <a href="https://www.joinblvd.com/b/sarahhitchcox/widget#/locations" class="b-btn-white" target="_blank" rel="noopener">
    ...
    <!-- ======== MOBILE STICKY BAR (B) ======== -->
    <div class="b-sticky">
        <a href="https://www.joinblvd.com/b/sarahhitchcox/widget#/locations" class="b-sticky-book" target="_blank" rel="noopener">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
            Book Online
        </a>
