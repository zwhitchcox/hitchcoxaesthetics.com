...
<head>
    ...
    <title>20% Off Kybella — Knoxville | Sarah Hitchcox Aesthetics</title>
    <meta name="description" content="20% off your first Kybella treatment. Permanently eliminate your double chin. Perfect 5.0 Google rating with 217+ reviews. RN-administered in Knoxville, TN. Book your appointment today.">
...
<body>
    ...
    <main>
            ...
            <div class="container">
                <div class="b-hero-grid">
                    <div class="b-hero-content">
                        ...
                        <h1>20% Off<br>Your First <span>Kybella Treatment</span></h1>
                        <p class="b-hero-price">New clients save <strong>20% on their first Kybella treatment</strong>. Permanently eliminate your double chin.</p>
            ...
            <div class="c-pricing-inner">
                ...
                <div class="c-pricing-grid">
                    <div class="c-price-card c-price-card-featured">
                        <div>
                            <div class="c-price-card-name">Kybella</div>
        ...
        <section class="b-results">
            <div class="container">
                ...
                <h2 class="b-section-title">Real Kybella Results</h2>
                <p class="b-section-sub">Real patients, real results — permanent double chin reduction.</p>
        ...
        <section class="c-faq">
            <div class="c-faq-inner">
                ...
                <div class="c-faq-item">
                    ...
                    <div class="c-faq-a">
                        <div class="c-faq-a-inner">Kybella uses synthetic deoxycholic acid — a naturally occurring molecule — to permanently destroy fat cells under the chin. Once those cells are gone, they can never store fat again.</div>
                    </div>
                </div>
                ...
                <div class="c-faq-item">
                    ...
                    <div class="c-faq-a">
                        <div class="c-faq-a-inner">Most patients need 2-4 sessions spaced about 4 weeks apart. Sarah will create a personalized plan during your consultation based on the amount of submental fat present.</div>
                    </div>
                </div>
                ...
                <div class="c-faq-item">
                    ...
                    <div class="c-faq-a">
                        <div class="c-faq-a-inner">You'll feel a series of small injections under the chin. Most patients describe mild stinging that subsides quickly. The treatment takes just 15-20 minutes.</div>
                    </div>
                </div>
                ...
                <div class="c-faq-item">
                    ...
                    <div class="c-faq-a">
                        <div class="c-faq-a-inner">Expect swelling under the chin for 3-7 days — this is completely normal and means it's working. Some bruising and tenderness is common. Most patients return to work the next day.</div>
                    </div>
                </div>
                ...
                <div class="c-faq-item">
                    ...
                    <div class="c-faq-a">
                        <div class="c-faq-a-inner">Yes! Once Kybella destroys fat cells, they're gone for good. As long as you maintain a stable weight, your results are permanent — no maintenance treatments needed.</div>
                    </div>
                </div>
    ...
    <section class="b-final">
        <div class="container">
            ...
            <p>New clients get 20% off their first Kybella treatment. Book your appointment today.</p>
