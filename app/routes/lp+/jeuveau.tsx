            ...
            <div class="container">
                <div class="b-hero-grid">
                    <div class="b-hero-content">
                        ...
                        <h1>20% Off<br>Your First <span>Jeuveau Treatment</span></h1>
                        <p class="b-hero-price">New clients save <strong>20% on their first Jeuveau treatment</strong>. See results in as little as 2 days.</p>
...
<div class="c-price-card-desc">Purpose-built wrinkle relaxer</div>
        ...
        <section class="c-faq">
            <div class="c-faq-inner">
                ...
                <div class="c-faq-item">
                    ...
                    <div class="c-faq-a">
                        <div class="c-faq-a-inner">Barely. The needles are ultra-fine and the entire treatment takes just 10-20 minutes. Most patients describe a mild pinch. You'll probably spend more time in the waiting room than in the chair.</div>
                    </div>
                </div>
                ...
                <div class="c-faq-item">
                    ...
                    <div class="c-faq-a">
                        <div class="c-faq-a-inner">Results typically last 3-4 months. With regular treatments, many clients find their results lasting longer as the muscles become trained to relax.</div>
                    </div>
                </div>
                ...
                <div class="c-faq-item">
                    ...
                    <div class="c-faq-a">
                        <div class="c-faq-a-inner">Jeuveau is FDA-approved for frown lines between the eyebrows. Sarah also uses it for forehead lines and crow's feet. She'll recommend the best treatment plan for your goals during your consultation.</div>
                    </div>
                </div>

                <div class="c-faq-item">
                    <button class="c-faq-q" aria-expanded="false" onclick="toggleFaq(this)">
                        What does Jeuveau cost?
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path d="M19 9l-7 7-7-7"/></svg>
                    </button>
                    <div class="c-faq-a">
    ...
    <section class="b-final">
        <div class="container">
            ...
            <p>New clients get 20% off their first Jeuveau treatment. Book your appointment today.</p>
