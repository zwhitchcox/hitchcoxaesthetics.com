...
<html lang="en">
	<head>
		...
		<!-- GTM HEAD: Replace GTM-XXXXXXX with actual container ID -->
		<!--
    ...
    -->
		...
		<style>
           ...
           ============================================= */
			...
			.c-price-card-featured .c-price-card-desc {
			...
			.c-faq-q[aria-expanded='true'] svg {
...
<!-- End Boulevard Self-Booking overlay -->
	...
	<body>
		<!-- GTM BODY: Replace GTM-XXXXXXX with actual container ID -->
		<!--
    ...
    -->
		...
		<main>
				...
				<div class="container">
					<div class="b-hero-grid">
						<div class="b-hero-content">
							...
							<h1>20% Off<br />Your First <span>Botox Treatment</span></h1>
							<p class="b-hero-price">
								New clients save <strong>20% on their first treatment</strong>.
								RN-administered with a perfect 5-star rating.
							</p>
							...
							<div class="b-hero-rating">
								...
								<div>
									...
									<span class="b-hero-rating-label"
										>217+ Five-Star Reviews</span
									>
								</div>
							</div>
			...
			<div class="b-proof-bar">
				<div class="b-proof-inner">
					<div class="b-proof-item">
						<svg viewBox="0 0 24 24" fill="var(--star)">
							<path
								d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"
							/>
						</svg>
			...
			<section class="c-pricing">
				<div class="c-pricing-inner">
					...
					<h2 class="c-pricing-heading">
						No hidden fees.<br />No upselling. Just results.
					</h2>
					<p
						style="
							font-size: 14px;
						...
						"
					>
						Know exactly what you're paying before you walk in. That's how it
						should be.
					</p>
					...
					<div class="c-pricing-grid" style="margin-bottom: 32px;">
						<div class="c-price-card c-price-card-featured">
							<div>
								<div class="c-price-card-name">Botox / Dysport</div>
								<div class="c-price-card-desc">
									Wrinkle relaxer, most popular
								</div>
							</div>
					...
					<div class="c-pricing-grid">
						<div class="c-price-card" style="border: 2px solid var(--accent); background: var(--accent-bg);">
							...
							<div class="c-price-card-right">
								<div class="c-price-card-amount" style="color: var(--accent)">
									20% Off
								</div>
								<a
									href="https://www.joinblvd.com/b/sarahhitchcox/widget#/locations"
					...
					<div class="b-ba-grid">
						<div>
							<div class="b-ba-pair">
								<div class="b-ba-img">
									<img
										src="/img/before-after/botox-crows-feet-001-before.webp"
										alt="Crow's feet treatment"
										loading="lazy"
									/><span class="b-ba-tag">Treatment</span>
								</div>
								<div class="b-ba-img">
									<img
										src="/img/before-after/botox-crows-feet-001-after.webp"
										alt="Crow's feet results"
										loading="lazy"
									/><span class="b-ba-tag">Results</span>
								</div>
							</div>
						...
						<div>
							<div class="b-ba-pair">
								<div class="b-ba-img">
									<img
										src="/img/before-after/botox-forehead-lines-001-before.webp"
										alt="Forehead lines treatment"
										loading="lazy"
									/><span class="b-ba-tag">Treatment</span>
								</div>
								<div class="b-ba-img">
									<img
										src="/img/before-after/botox-forehead-lines-001-after.webp"
										alt="Forehead lines results"
										loading="lazy"
									/><span class="b-ba-tag">Results</span>
								</div>
							</div>
						...
						<div>
							<div class="b-ba-pair">
								<div class="b-ba-img">
									<img
										src="/img/before-after/botox-frown-lines-001-before.webp"
										alt="Frown lines treatment"
										loading="lazy"
									/><span class="b-ba-tag">Treatment</span>
								</div>
								<div class="b-ba-img">
									<img
										src="/img/before-after/botox-frown-lines-001-after.webp"
										alt="Frown lines results"
										loading="lazy"
									/><span class="b-ba-tag">Results</span>
								</div>
							</div>
				...
				<div class="c-testimonial-featured-inner">
					...
					>
						<div style="display: flex; gap: 2px">
							...
							>
								<path
									d="M10 1.5l2.47 5.01 5.53.8-4 3.9.94 5.49L10 14.26 5.06 16.7l.94-5.49-4-3.9 5.53-.8z"
								/>
							</svg>
							<svg
								viewBox="0 0 20 20"
						...
						<span
							style="font-size: 14px; font-weight: 600; color: var(--gray-700)"
							>217+ Five-Star Reviews on Google</span
						>
					</div>
					<div class="c-quote-mark">&ldquo;</div>
					<p class="c-quote-text">
						She is a true artist! Incredibly gentle, thorough and professional.
						Extremely knowledgeable &amp; knows everything there is to know
						about medical aesthetics. Happy is an understatement.
					</p>
					<p class="c-quote-attr">
						<strong>Sarah Webb</strong> &mdash; Local Guide &middot; Google
						Review
					</p>
				</div>
			</section>
					...
					<div class="c-reviews-grid">
						<div class="c-review-card">
							<div class="c-review-top">
								...
								<svg class="c-review-g" viewBox="0 0 24 24">
									<path
							...
							<p class="c-review-text">
								Sarah did an amazing job with my Dysport. She's incredibly
								knowledgeable, took the time to explain everything, and made me
								feel completely at ease. The clinic space is cute and welcoming.
								I trust her fully with my face!
							</p>
						</div>
						<div class="c-review-card">
							<div class="c-review-top">
							...
							<p class="c-review-text">
								She is a true artist! Incredibly gentle, thorough and
								professional. She is extremely knowledgeable and knows
								everything there is to know about medical aesthetics. I highly
								recommend!
							</p>
						</div>
						<div class="c-review-card">
							...
							<p class="c-review-text">
								Had a great first experience getting Jeuveau injected! I was in
								and out in less than 30 minutes. Sarah was super helpful and
								answered all my questions! I'll definitely be back!
							</p>
						</div>
						<div class="c-review-card">
							<div class="c-review-top">
							...
							<p class="c-review-text">
								Sarah is absolutely the best! I was nervous but the whole
								experience has been amazing. She takes her time to explain and
								makes sure you're comfortable. Could not recommend her more!
							</p>
						</div>
						<div class="c-review-card">
							<div class="c-review-top">
							...
							<p class="c-review-text">
								Sarah was super friendly and knowledgeable. She guided me
								towards the best plan of action and explained why. She even let
								me know about discounts via reward programs that could be
								applied to my treatments!
							</p>
						</div>
						<div class="c-review-card">
							<div class="c-review-top">
			...
			<section class="b-provider">
				<div class="container">
					<div class="b-provider-card">
						<div class="b-provider-photo">
							<img
								src="https://hitchcoxaesthetics.com/img/sarah.jpg"
								alt="Sarah Hitchcox, RN"
								loading="lazy"
							/>
						</div>
						<div>
							...
							<p class="b-provider-cred">
								Registered Nurse · Aesthetic Injector · DNP Candidate
							</p>
							<p class="b-provider-bio">
			...
			<section class="c-faq">
				<div class="c-faq-inner">
					...
					<div class="c-faq-item">
						...
						<div class="c-faq-a">
							<div class="c-faq-a-inner">
								Results typically last 3-4 months. With regular treatments, many
								clients find their results last longer over time as the muscles
					...
					<div class="c-faq-item">
						...
						<div class="c-faq-a">
							<div class="c-faq-a-inner">
								Most clients describe it as a small pinch. Sarah uses ultra-fine
								needles and a gentle technique. The entire treatment takes about
								15 minutes with minimal discomfort.
							</div>
						</div>
					</div>
					...
					<div class="c-faq-item">
						...
						<div class="c-faq-a">
							<div class="c-faq-a-inner">
								Not with Sarah. She takes a conservative, natural-looking
								approach. You'll still have full facial expression -- just fewer
								wrinkles. She starts subtle and can always add more at a
								follow-up.
							</div>
						</div>
					</div>
					...
					<div class="c-faq-item">
						...
						<div class="c-faq-a">
							<div class="c-faq-a-inner">
								Sarah operates a lean, independent practice without the overhead
								of large med spas. Lower costs get passed directly to you --
								same premium product, same expert care, better price.
							</div>
						</div>
					</div>
					...
					<div class="c-faq-item">
						...
						<div class="c-faq-a">
							<div class="c-faq-a-inner">
								The most popular areas are forehead lines, frown lines (11s),
								and crow's feet. Sarah also treats bunny lines, lip flip, brow
								lift, chin dimpling, masseter/TMJ, neck bands, gummy smile, and
								hyperhidrosis.
							</div>
						</div>
					</div>
					...
					<div class="c-faq-item">
						<button
							...
							onclick="toggleFaq(this)"
						>
							What's the 20% first-visit discount?
							<svg
								xmlns="http://www.w3.org/2000/svg"
								fill="none"
								viewBox="0 0 24 24"
						...
						<div class="c-faq-a">
							<div class="c-faq-a-inner">
								New clients receive 20% off their first treatment. No code
								needed -- just mention it at your appointment or book through
								this page. It applies to all services.
							</div>
						</div>
					</div>
				</div>
			...
			<section class="b-locations">
				<div class="container">
					...
					<p class="b-section-sub" style="margin-bottom: 28px">
					...
					<div class="b-loc-grid">
						<div class="b-loc-card">
							...
							<p class="b-loc-address">
								5113 Kingston Pike, Suite 15<br />Knoxville, TN 37919
							</p>
							<div class="b-loc-actions">
								<a
									href="https://maps.google.com/?q=5113+Kingston+Pike+Suite+15+Knoxville+TN+37919"
									class="b-loc-link"
									target="_blank"
									rel="noopener"
								>
						...
						<div class="b-loc-card">
							...
							<p class="b-loc-address">
								102 S Campbell Station Rd, Suite 8<br />Farragut, TN 37934
							</p>
							<div class="b-loc-actions">
								<a
									href="https://maps.google.com/?q=102+S+Campbell+Station+Rd+Suite+8+Farragut+TN+37934"
									class="b-loc-link"
									target="_blank"
									rel="noopener"
								>
		...
		<section class="b-final">
			<div class="container">
				...
				<p>
					New clients get 20% off their first Botox treatment. Book your
					appointment today.
				</p>
		...
		<footer class="b-footer">
			<div class="container">
				...
				<div>
					<a href="tel:8654261826">(865) 426-1826</a> ·
					<a href="mailto:sarah@hitchcoxaesthetics.com"
						>sarah@hitchcoxaesthetics.com</a
					>
				</div>
				<div style="margin-top: 12px; font-size: 12px">
					&copy; 2026 Sarah Hitchcox Aesthetics. All rights reserved.
				</div>
			</div>
		</footer>
